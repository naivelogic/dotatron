...
INPUT_DIR=${MNT_ROOT}/images/dotav2_1024split/val/images/
OUTPUT_DIR=${MNT_ROOT}/experiments/detectron2/080421_dotatrainval_devkit_frcnn_X101_nc24x01/dotav2_1024split_val
CONF=0.6
USE_GPU=True
CKPT_PATH=${MNT_ROOT}/experiments/detectron2/080421_dotatrainval_devkit_frcnn_X101_nc24x01/model_0019999.pth
NUM_IMAGES=20
python task1_eval.py --input_dir ${INPUT_DIR} --output_dir ${OUTPUT_DIR} --conf ${CONF} \
