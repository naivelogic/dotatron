    ...
    for fullname in filelist:
        ...
        with open(fullname, 'r') as f_in:
            ...
            for splitline in splitlines:
                ...
                poly = list(map(float, splitline[2:10])) #Each element maps to floats and is then placed in the list
                ...
                if (oriname not in nameboxdict):
                    nameboxdict[oriname] = []
                    nameboxdict_classname[oriname] = list() #Get a tuple and gather the original target information
